...
async def shark1(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  ᯓ 𝚂𝙾𝚞𝚁𝙲𝙴 𝙰𝙵𝚁𝙾𝚃𝙾𝙾 ‌⧽=====☭
: ⦑   قائمة اوامر الخاص في سورس رولكس  ⦒
☭ تفعيل ، تعطيل الترحيب 
☭ قبول ، رفض
☭ كتم ، الغاء كتم 
...
async def shark2(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  ᯓ 𝚂𝙾𝚞𝚁𝙲𝙴 𝙰𝙵𝚁𝙾𝚃𝙾𝙾 ‌⧽=====☭
: ⦑   قائمة اوامر الجروبات في سورس رولكس  ⦒
☭ حظر ، الغاء حظر
☭ مسح المحظورين
☭ كتم ، الغاء كتم 
☭ مسح المكتومين
...
async def shark3(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  ᯓ 𝚂𝙾𝚞𝚁𝙲𝙴 𝙰𝙵𝚁𝙾𝚃𝙾𝙾 ‌ ⧽=====☭
: ⦑   قائمة اوامر اليوتيوب في سورس رولكس  ⦒
☭ غ + اسم الاغنيه
☭ ف + اسم الفيديو
☭=====⧼ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
""",
...
async def shark4(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر الاذاعه في سورس رولكس  ⦒
...
async def shark5(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر الرفع في سورس رولكس  ⦒
...
async def shark6(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة الاوامر الاضافيه في سورس رولكس  ⦒
...
async def shark7(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر التسليه في سورس رولكس  ⦒
☭ `.مكعبات`
☭ `.قمر`
☭ `.قلوب`
☭ `.قلب`
...
async def shark8(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر التسليه 2 في سورس رولكس  ⦒
☭ `.غبي`
☭ `.تفجير`
☭ `.طوبه`
☭ `.مربعات`
...
async def shark9(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر التسليه 3 في سورس رولكس  ⦒
☭ `.رموز شيطانيه`
☭ `.اسعاف`
☭ `شرطه`
☭ `.زعلت`
...
☭ `.عبقري`
☭ `.قتل`
☭ انتظرو تحديثات عظمه ل تليثون سورس رولكس 🔥
☭=====⧼ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
""",
    ]
    for i in animation_ttl:
...
async def shark10(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر الالعاب في سورس رولكس  ⦒
 ☭ `.اكس او` 
...
async def shark11(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر الالعاب المتطوره في سورس رولكس  ⦒
 ☭ `.القط المجنون` 
☭ `.ركل الكره`
☭ `.السمك الشائك`
☭ `.كرة السله`
...
async def shark12(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر الميمز في سورس رولكس  ⦒
☭ `.هنضحك`
☭ `.مينفعش`
...
async def shark13(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر الميمز 2 في سورس رولكس  ⦒
☭ `.في رمضان`
☭ `.مش عارف اقوم`
☭ `.دمك خفيف اوي`
...
async def shark14(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر الميمز 3 في سورس رولكس  ⦒
☭ `.تاخد نفس عميق`
☭ `.ربنا نصرني`
☭ `.لو معايا خنجرين`
☭ `.اماااال`
...
async def shark15(c, msg):
    ...
    animation_chars = [
        """
☭=====⧼  𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ⧽=====☭
: ⦑   قائمة اوامر النسب في سورس رولكس  ⦒
☭ `.نسبة الانوثة`
☭ `.نسبة الغباء`
☭ `.نسبة الرجولة`
☭ `.نسبة المنيكه`
...
async def source(c,msg):
  await msg.edit("⋖⊶◎⊷⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒🇪🇬⌯⊶◎⊷⋗\n☭ ¦ 𝐃𝐄𝐕 𝐉𝐎𝐎 ➼ @YouSsf_ELJOO\n☭ ¦ 𝐒𝐎𝐔𝐑𝐂𝐄 ➼ @source_rolexs\n⋖⊶◎⊷⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒🇪🇬⌯⊶◎⊷⋗")
