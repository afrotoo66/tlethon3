...
async def mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 6988786007:
            return await msg.edit("• لا يمكنك كتم عفرتو")
...
async def un_mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 6988786007:
            return await msg.edit("• لا يمكنك الغاء كتم عفرتو")
...
async def bann(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 6988786007:
        return await msg.edit("• لا يمكنك حظر عفرتو")
    try:
...
async def un_ban(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 6988786007:
        return await msg.edit("• لا يمكنك الغاء حظر عفرتو")
    try:
