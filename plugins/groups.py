...
async def mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 5904216848:
            return await msg.edit("☭ لا يمكنك كتم المبرمج عفرتو ")
...
async def un_mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 5904216848:
            return await msg.edit("☭ لا يمكنك الغاء كتم المبرمج عفرتو ")
...
async def bann(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 5904216848:
        return await msg.edit("☭ لا يمكنك حظر المبرمج عفرتو ")
    try:
...
async def un_ban(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 5904216848:
        return await msg.edit("☭ لا يمكنك الغاء حظر المبرمج عفرتو ")
    try:
